...
local language_servers = {
  clangd = {
    ...
    cmd = { "/usr/local/clang/21.0.0/bin/clangd", "--function-arg-placeholders=0", "--completion-style=detailed", "--query-driver=/usr/bin/gcc,/usr/bin/g++,/usr/bin/g++14,/usr/local/clang/21.0.0/bin/clang++" },
    settings = {}
  },
